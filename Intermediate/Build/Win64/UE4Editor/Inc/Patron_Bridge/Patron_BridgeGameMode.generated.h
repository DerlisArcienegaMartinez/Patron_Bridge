...
#ifdef PATRON_BRIDGE_Patron_BridgeGameMode_generated_h
#error "Patron_BridgeGameMode.generated.h already included, missing '#pragma once' in Patron_BridgeGameMode.h"
#endif
...
public: \
	DECLARE_CLASS(APatron_BridgeGameMode, AGameModeBase, COMPILED_IN_FLAGS(0 | CLASS_Transient | CLASS_Config), CASTCLASS_None, TEXT("/Script/Patron_Bridge"), PATRON_BRIDGE_API) \
...
#define Patron_Bridge_Source_Patron_Bridge_Patron_BridgeGameMode_h_12_STANDARD_CONSTRUCTORS \
	...
	DECLARE_VTABLE_PTR_HELPER_CTOR(PATRON_BRIDGE_API, APatron_BridgeGameMode); \
DEFINE_VTABLE_PTR_HELPER_CTOR_CALLER(APatron_BridgeGameMode); \
private: \
	/** Private move- and copy-constructors, should never be used */ \
	PATRON_BRIDGE_API APatron_BridgeGameMode(APatron_BridgeGameMode&&); \
	PATRON_BRIDGE_API APatron_BridgeGameMode(const APatron_BridgeGameMode&); \
public:
...
template<> PATRON_BRIDGE_API UClass* StaticClass<class APatron_BridgeGameMode>();

#undef CURRENT_FILE_ID
#define CURRENT_FILE_ID Patron_Bridge_Source_Patron_Bridge_Patron_BridgeGameMode_h
