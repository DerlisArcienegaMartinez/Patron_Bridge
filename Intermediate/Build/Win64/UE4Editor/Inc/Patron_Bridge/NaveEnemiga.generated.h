...
#ifdef PATRON_BRIDGE_NaveEnemiga_generated_h
...
template<> PATRON_BRIDGE_API UClass* StaticClass<class ANaveEnemiga>();

#undef CURRENT_FILE_ID
#define CURRENT_FILE_ID Patron_Bridge_Source_Patron_Bridge_NaveEnemiga_h
